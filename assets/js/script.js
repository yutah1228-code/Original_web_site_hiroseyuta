...
const SHOP_ITEMS = [
  // 武器
  { key: "dagger",        name: "短剣",     price: 400,  kind: "weapon", stat: { STR: 4 }, durability: 40 },
  { key: "iron_sword",       name: "鉄の剣",       price: 1500, kind: "weapon", stat: { STR: 8 }, durability: 60 },
  { key: "mercenary_sword",  name: "傭兵の剣",     price: 3000, kind: "weapon", stat: { STR: 12 }, durability: 60, crit: 0.05 },
  { key: "silver_sword",     name: "銀の剣",       price: 5000, kind: "weapon", stat: { STR: 15, AGL: 5 }, durability: 30 },
  { key: "thunder_sword",    name: "雷鳴の剣",     price: 6000, kind: "weapon", stat: { STR: 12 }, durability: 50, thunder: true },
  { key: "vampire_sword",    name: "吸血剣",       price: 7000, kind: "weapon", stat: { STR: 12 }, durability: 50, drain: true },
  { key: "grimoire",         name: "魔導書",       price: 1800, kind: "weapon", stat: { MAG: 8 }, durability: 60 },
  { key: "mage_staff",       name: "魔導士の杖",   price: 3200, kind: "weapon", stat: { MAG: 8 }, durability: 30 },
  { key: "spirit_staff",     name: "精霊の杖",     price: 5300, kind: "weapon", stat: { MAG: 14, MP: 10 }, durability: 30 },
  {key: "legend_sword",name: "伝説の剣",price: 0,kind: "weapon",stat: { STR: 35, AGL: 10, LUCK: 10 },durability: 999,crit: 0.15},
  { key: "cutlass", name: "カトラス", price: 4200, kind: "weapon", stat: { STR: 14, AGL: 3 }, durability: 50 },
{ key: "marine_rapier", name: "マリンレイピア", price: 4800, kind: "weapon", stat: { STR: 12, AGL: 6 }, durability: 45 },
{ key: "trident", name: "三叉槍", price: 5600, kind: "weapon", stat: { STR: 18 }, durability: 55 },

  // 防具
  { key: "leather_armor", name: "革の鎧",   price: 1200, kind: "armor",  stat: { GRD: 4 }, durability: 40 },
  { key: "iron_armor",       name: "鉄の鎧",       price: 2500, kind: "armor",  stat: { GRD: 7 }, durability: 40 },
  { key: "steel_armor",      name: "鋼の鎧",       price: 5000, kind: "armor",  stat: { GRD: 12 }, durability: 40 },
  { key: "magic_robe",       name: "魔道のローブ", price: 2500, kind: "armor",  stat: { GRD: 6 }, durability: 40 },
  { key: "priest_robe",      name: "司祭のローブ", price: 4500, kind: "armor",  stat: { GRD: 10 }, durability: 40 },

  // 盾
  { key: "leather_shield",name: "革の盾",   price: 900,  kind: "shield", stat: { GRD: 3 }, durability: 4 },
  { key: "iron_shield",      name: "鉄の盾",       price: 1500, kind: "shield", stat: { GRD: 7 }, durability: 4 },
  ...
  // MP回復
  { key: "mana_fragment",    name: "魔石片",       price: 500,  kind: "consumable", effectType: "heal_mp", value: 5, usesPerBuy: 1 },
  { key: "lesser_mana",      name: "下級魔石",     price: 1000, kind: "consumable", effectType: "heal_mp", value: 10, usesPerBuy: 1 },
  { key: "middle_mana",      name: "中級魔石",     price: 2000, kind: "consumable", effectType: "heal_mp", value: 20, usesPerBuy: 1 },

  // バフ
  { key: "power_drug",       name: "力の薬",       price: 1000, kind: "consumable", effectType: "buff", statName: "STR", value: 5, turns: 3, usesPerBuy: 1 },
  { key: "guard_drug",       name: "守りの薬",     price: 1000, kind: "consumable", effectType: "buff", statName: "GRD", value: 5, turns: 3, usesPerBuy: 1 },
  { key: "magic_drug",       name: "魔力の薬",     price: 1000, kind: "consumable", effectType: "buff", statName: "MAG", value: 5, turns: 3, usesPerBuy: 1 },

  // 素材系
{ key: "nereid_tear", name: "ネレイドの涙", price: 1200, kind: "material" },
{ key: "ocean_herb", name: "オーシャンハーブ", price: 800, kind: "material" },
{ key: "sea_crystal", name: "シークリスタル", price: 2000, kind: "material" },
